...
def read_data(spark_session):
    ...
    url = 'hdfs://spark01.ctweb.inweb.org.br:9000/limonero/data/0d6b6e1cee844d9bac6b028b04ed9c38_iris.csv'
...
def create_pipeline(label: str):
    ...
    kmeans_0 = clustering.KMeans(**common_params)

    # Lemonade internal use
    kmeans_0.task_id = '54078035-18f8-4d7b-b00f-ad524eb35dfc'
    kmeans_0.task_name = 'Agrupamento K-Means (KMeans)'
    kmeans_0.operation_id = 2355
...
def main(spark_session: any, cached_state: dict, emit_event: callable):
    ...
    try:
        ...
        df = df.sample(False, fraction=10000/df.count(), seed=1406201934)
        ...
        if not dataframe_util.handle_spark_exception(e):
            # Add additional print statements to catch any errors
            print("An error occurred during Spark job execution:", e)
