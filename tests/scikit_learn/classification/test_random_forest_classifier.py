...
def test_random_forest_classifier_success():
    ...
    instance = RandomForestClassifierOperation(**arguments)
    ...
    model_1 = RandomForestClassifier(n_estimators=10,
                                     ...
                                     oob_score=False, n_jobs=None, ccp_alpha=0.0,
                                     max_samples=None)
...
def test_random_forest_classifier_ccp_alpha_param_success():
    ...
    model_1 = RandomForestClassifier(n_estimators=10,
                                     ...
                                     max_features=None, max_leaf_nodes=None,
                                     min_impurity_decrease=0.0, bootstrap=True,
                                     oob_score=False, n_jobs=None, ccp_alpha=0.5,
                                     max_samples=None)
    assert not result['out'].equals(test_df)
    assert str(result['model_1']) == str(model_1)
...
def test_random_forest_classifier_missing_label_param_fail():
    ...
    with pytest.raises(ValueError) as val_err:
        RandomForestClassifierOperation(**arguments)
...
def test_random_forest_classifier_invalid_ccp_min_impurity_decrease_params_fail():
    vals = [
        'ccp_alpha',
...
def test_random_forest_classifier_invalid_min_split_min_leaf_n_estimators_params_fail():
    vals = [
        'min_samples_split',
        'min_samples_leaf',
        'n_estimators'
