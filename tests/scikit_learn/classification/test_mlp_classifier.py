...
from juicer.scikit_learn.classification_operation import MLPClassifierOperation
...
def test_mlp_classifier_invalid_tol_param_fail():
    ...
    with pytest.raises(ValueError) as val_err:
        MLPClassifierOperation(**arguments)
...
def test_mlp_classifier_invalid_validation_fraction_param_fail():
    ...
    with pytest.raises(ValueError) as val_err:
        MLPClassifierOperation(**arguments)
    assert "Parameter 'validation_fraction' must be x between 0 and 1 for task" \
