...
def generated_chart(get_arguments, get_df):
    ...
    code = '\n'.join(["import plotly.graph_objects as go",
                      "import plotly.express as px", "import json",
...
def test_alignmentgroup(generated_chart):
    ...
    assert alignmentgroup is not None, \
        "'alignmentgroup' not found in data object"
...
def test_orientation(generated_chart):
    ...
    assert orientation is not None, \
        "'orientation' field not found in data object"
...
def test_textposition(generated_chart):
    ...
    assert textposition is not None, \
        "'textposition' field not found in data object"
