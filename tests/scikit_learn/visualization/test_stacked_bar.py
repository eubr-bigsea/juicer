...
def test_hovertemplate(generated_chart):
    ...
    ), "incorrect hovertemplate for one or multiple classes"
...
def test_legendgroup(generated_chart):
    ...
    ), "incorrect legendgroup for one or multiple classes"
...
def test_orientation(generated_chart):
    ...
    ), "incorrect orientation for one or multiple classes"
...
def test_showlegend(generated_chart):
    ...
    ), "incorrect showlegend for one or multiple classes"
...
def test_xaxis(generated_chart):
    ...
    ), "incorrect 'xaxis' values for one or multiple classes"
...
def test_yaxis(generated_chart):
    ...
    ), "incorrect 'yaxis' values for one or multiple classes"
...
def test_type(generated_chart):
    ...
    ), "incorrect 'type' values for one or multiple classes"
...
def test_xaxis(generated_chart):
    ...
    assert xaxis.get("domain") == [0.0, 1.0], "incorrect 'domain' value in 'xaxis'"
    assert xaxis.get("title") == {"text": "class"}, "incorrect 'title' value in 'xaxis'"
    assert (
        xaxis.get("categoryorder") == "trace"
    ), "incorrect 'categoryorder' value in 'xaxis'"
...
def test_yaxis(generated_chart):
    ...
    assert yaxis.get("domain") == [0.0, 1.0], "incorrect 'domain' value in 'yaxis'"
    assert yaxis.get("title") == {"text": "value"}, "incorrect 'title' value in 'yaxis'"
    assert yaxis.get("showgrid") == True, "incorrect 'showgrid' value in 'yaxis'"
    assert (
        yaxis.get("gridcolor") == "rgba(255,0,0,.10)"
    ), "incorrect 'gridcolor' value in 'yaxis'"
    assert yaxis.get("visible") == True, "incorrect 'visible' value in 'yaxis'"
    assert yaxis.get("tickformat") == ".3f", "incorrect 'tickformat' value in 'yaxis'"
...
def test_legend(generated_chart):
    ...
    assert legend.get("title") == {
        "text": "Série"
    }, "incorrect 'title' value in 'legend'"
    assert (
        legend.get("tracegroupgap") == 0
    ), "incorrect 'tracegroupgap' value in 'legend'"
