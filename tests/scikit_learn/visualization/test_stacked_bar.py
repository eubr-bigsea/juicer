...
def test_x(generated_chart):
    ...
    expected_xs = [['Iris-setosa', 'Iris-versicolor', 'Iris-virginica'], ['Iris-setosa', 'Iris-versicolor', 'Iris-virginica']]
...
def test_xaxis(generated_chart):
    ...
    assert xaxis.get('categoryorder') == 'trace', "incorrect 'categoryorder' value in 'xaxis'"
...
def test_yaxis(generated_chart):
    ...
    assert yaxis.get('gridcolor') == 'rgba(255,0,0,.10)', "incorrect 'gridcolor' value in 'yaxis'"
...
def test_legend(generated_chart):
    ...
    assert legend.get('title') == {'text': 'Série'}, "incorrect 'title' value in 'legend'"
    assert legend.get('tracegroupgap') == 0, "incorrect 'tracegroupgap' value in 'legend'"
