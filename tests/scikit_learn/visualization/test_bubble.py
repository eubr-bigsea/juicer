...
def test_data_hovertemplate(generated_chart):
    ...
    for scatter_data in data:
        ...
        assert 'petallength=%{marker.size}' in hovertemplate, "'petallength=%{marker.size}' text not found in 'hovertemplate'"
        assert '<extra></extra>' in hovertemplate, "'<extra></extra>' text not found in 'hovertemplate'"
...
def test_layout_xaxis(generated_chart):
    ...
    assert xaxis['title']['text'] == 'petalwidth', "incorrect 'text' value field in  'title' of 'xaxis'"
...
def test_layout_yaxis(generated_chart):
    ...
    assert yaxis['title']['text'] == 'mean(sepallength)', "incorrect 'text' value field in  'title' of 'yaxis'"
...
def test_layout_legend(generated_chart):
    ...
    assert legend['title']['text'] == 'class', "incorrect 'text' value field in  'title' of 'legend'"
