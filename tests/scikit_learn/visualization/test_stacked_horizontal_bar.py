...
def test_alignmentgroup(generated_chart):
    ...
    assert alignmentgroups == expected_alignmentgroups, "incorrect 'alignmentgroup' value for one or multiple series"
...
def test_hovertemplate(generated_chart):
    ...
    assert hovertemplates == expected_hovertemplates, "incorrect hoverplate for one or multiple series"
...
def test_legendgroup(generated_chart):
    ...
    assert legendgroups == expected_legendgroups, "incorret legendgroup for one or multiple series"
...
def test_offsetgroup(generated_chart):
    ...
    assert offsetgroups == expected_offsetgroups, "incorrect 'offsetgroup' value for one or multiple series"
...
def test_orientation(generated_chart):
    ...
    assert orientations == expected_orientations, "incorrect orientation value for one or multiple series"
...
def test_showlegend(generated_chart):
    ...
    assert showlegends == expected_showlegends, "incorrect showlegend value for one or multiple series"
...
def test_textposition(generated_chart):
    ...
    assert textpositions == expected_textpositions, "incorrect 'textposition' value for one or multiple series"
...
def test_xaxis(generated_chart):
    ...
    expected_xaxes = ['x', 'x']
    assert xaxes == expected_xaxes, "incorrect 'xaxis' values for one or multiple series"
...
def test_yaxis(generated_chart):
    ...
    expected_yaxes = ['y', 'y']
    assert yaxes == expected_yaxes, "incorrect 'yaxis' values for one or multiple series"
