...
def test_data_dimensions(generated_chart):
    ...
    assert (
        data_dimensions is not None
    ), "Field 'dimensions' not found in the data object"
    expected_dimensions = [
        {
            "label": "min(PetalLengthCm)",
            "values": [
                1.3,
                1.1,
                1.0,
    ...
    assert (
        data_dimensions == expected_dimensions
    ), "Incorrect values for 'dimensions' field"
...
def test_layout_coloraxis(generated_chart):
    ...
    ), "Field 'coloraxis' not found in the layout object"
    expected_coloraxis = {
